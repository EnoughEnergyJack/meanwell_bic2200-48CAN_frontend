# Meanwell BIC2200 Front-End Controller

- Many companies develop things that are critical for development, but are not needed for their products/IP. This is one of those developments.
- It is a front-end PCB/Screen that allows you to control the Meanwell BIC2200-48CAN as if it were a Bench PSU, very simple, mostly generated by AI prompts.
- The psu itself is great because it is bidirectional, you can set it as a supply or a regenerative load, up to ~2.2kW.
- If this is useful to you, give Enough Energy Ltd a shoutout, but to be clear this was mostly a "quick and dirty"(but very effective) PCB to help our other developments along.
